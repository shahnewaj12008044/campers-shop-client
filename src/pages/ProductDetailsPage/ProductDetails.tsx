  ...
  return (
    ...
    <div className="flex flex-col md:flex-row gap-8 p-4 items-center">
      ...
      <div className="md:w-1/2">
        ...
        <p className="text-gray-700 mb-4 hover:text-lime-400">{data?.data?.description}</p>
        <div className="flex items-center mb-4">
          <span className="text-gray-700 font-medium mr-2 hover:text-lime-400">Category:</span>
          <span className="text-gray-600 hover:text-lime-400">{data?.data?.category}</span>
        </div>
        <div className="flex items-center mb-4">
